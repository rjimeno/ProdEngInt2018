...
# https://github.com/SKantar/InterviewBit/blob/master/02_Arrays/triplets_with_sum_between_given_range%20.py
# and improved the tests (rjimeno).
...
class Solution:
    ...
    def solve(self, A):
        """
        >>> s = Solution()
        >>> a_a = [ "2.673662", "2.419159", "0.573816", "2.454376", "0.403605", "2.503658", "0.806191" ]
        >>> s.solve(a_a)
        1

        >>> a_a = [ "0.234022", "0.051717", "0.820402", "0.492629", "0.004825", "0.589073" ]
        >>> s.solve(a_a)
        1

        >>> a_a = ["0.6", "0.7", "0.8", "1.2", "0.4"]
        >>> s.solve(a_a)
        1

        >>> a_a = ["0.628934", "0.939859", "0.898308", "1.251313", "1.380492", "1.070370", "0.701036", "1.349819", "1.277858", "1.171202"]
        >>> s.solve(a_a)
        0
